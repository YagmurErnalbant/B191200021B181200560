...
def detection():
  ...
  image1 = cv2.imread('hairsaloon/image1.png')
  image2 = cv2.imread('hairsaloon/image2.png')
  ...
  image1_swapped[faces1[0].top():faces1[0].bottom(), faces1[0].left():faces1[0].right()] = face2_aligned[faces1[0].top():faces1[0].bottom(), faces1[0].left():faces1[0].right()]

  image2_swapped = image2.copy()
  image2_swapped[faces2[0].top():faces2[0].bottom(), faces2[0].left():faces2[0].right()] = image1[faces2[0].top():faces2[0].bottom(), faces2[0].left():faces2[0].right()]

  # Save the swapped images

  # Save the processed images
  cv2.imwrite('hairsaloon/proccessed/proccessed_image1.jpg', image1_swapped)
  cv2.imwrite('hairsaloon/proccessed/proccessed_image2.jpg', image2_swapped)

  print("Faces saved as 'proccessed_image1.jpg' and 'proccessed_image2.jpg'.")
